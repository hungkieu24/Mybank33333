                        ...
                        <ul class="faq-question__tab-list">
                            <c:forEach items="${listType}" var="item" >
                                <li class="faq-question__tab">
                                    <c:choose>
                                        <c:when test="${item == 'borrow'}">Vay</c:when>
                                        <c:when test="${item == 'savings'}">Gửi</c:when>
                                        <c:when test="${item == 'account'}">Tài khoản</c:when>
                                        <c:when test="${item == 'card'}">Thẻ</c:when>
                            ...
                            <c:forEach items="${listType}" var="type">
                                <div class="faq-question__content">
                                    <ol class="faq-question__ques-list">
                                        <c:forEach items="${faqMap[type]}" var="faq">
