 ...
 * @author ADMIN
 */
@WebServlet(name="FaqSearchbyQuestion", urlPatterns={"/seller/faq-search-question"})
public class FaqSearchbyQuestion extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FaqSearchbyQuestion</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet FaqSearchbyQuestion at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        list = dao.searchFAQsByQuestion(searchKeyword);
