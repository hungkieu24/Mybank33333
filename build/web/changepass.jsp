                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-9">
                            <div class="mil-banner-text mil-text-center">
                                <h2 class="mil-mb-80" style="font-family: serif">Reset your password for email</h2>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-5">
                                <c:set var="cookie" value="${pageContext.request.cookies}"></c:set>
                                    <form action="changePass" method="post" style="background: #ccffcc; padding: 30px" onsubmit="validateForm(event)">
